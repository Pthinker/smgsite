...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mysmg_user', (
            ...
            ('new_password', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ...
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ...
            ('security_question', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('security_answer', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('confkey', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ('contact', self.gf('django.db.models.fields.CharField')(default=u'0', max_length=1)),
        ))
        db.send_create_signal(u'mysmg', ['User'])

        # Adding model 'Link'
        db.create_table(u'mysmg_link', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'mysmg', ['Link'])

        # Adding model 'UserProfile'
        db.create_table(u'mysmg_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mysmg.User'], unique=True)),
        ))
        db.send_create_signal(u'mysmg', ['UserProfile'])

        # Adding M2M table for field my_doctors on 'UserProfile'
        m2m_table_name = db.shorten_name(u'mysmg_userprofile_my_doctors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'mysmg.userprofile'], null=False)),
            ('doctor', models.ForeignKey(orm[u'doctors.doctor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'doctor_id'])

        # Adding M2M table for field my_services on 'UserProfile'
        m2m_table_name = db.shorten_name(u'mysmg_userprofile_my_services')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'mysmg.userprofile'], null=False)),
            ('service', models.ForeignKey(orm[u'services.service'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'service_id'])

        # Adding M2M table for field my_library on 'UserProfile'
        m2m_table_name = db.shorten_name(u'mysmg_userprofile_my_library')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'mysmg.userprofile'], null=False)),
            ('link', models.ForeignKey(orm[u'mysmg.link'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'link_id'])


    def backwards(self, orm):
        # Deleting model 'User'
        db.delete_table(u'mysmg_user')

        # Deleting model 'Link'
        db.delete_table(u'mysmg_link')

        # Deleting model 'UserProfile'
        db.delete_table(u'mysmg_userprofile')

        # Removing M2M table for field my_doctors on 'UserProfile'
        db.delete_table(db.shorten_name(u'mysmg_userprofile_my_doctors'))

        # Removing M2M table for field my_services on 'UserProfile'
        db.delete_table(db.shorten_name(u'mysmg_userprofile_my_services'))

        # Removing M2M table for field my_library on 'UserProfile'
        db.delete_table(db.shorten_name(u'mysmg_userprofile_my_library'))
    ...
    models = {
        ...
        u'mysmg.user': {
            ...
            'confkey': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            'contact': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            ...
            'middle_name': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'new_password': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '19', 'blank': 'True'}),
            'security_answer': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'security_question': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
        ...
        u'mysmg.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'my_doctors': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['doctors.Doctor']", 'symmetrical': 'False'}),
            'my_library': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['mysmg.Link']", 'symmetrical': 'False'}),
            'my_services': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['services.Service']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mysmg.User']", 'unique': 'True'})
        },
        u'services.service': {
