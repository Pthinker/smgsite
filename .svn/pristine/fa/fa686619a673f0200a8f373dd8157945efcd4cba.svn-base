...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.large_image'
        db.add_column(u'services_service', 'large_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='db/images/no_image.jpg', max_length=100),
                      keep_default=False)

        # Adding field 'Service.small_image'
        db.add_column(u'services_service', 'small_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='db/images/no_image.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.large_image'
        db.delete_column(u'services_service', 'large_image')

        # Deleting field 'Service.small_image'
        db.delete_column(u'services_service', 'small_image')
    ...
    models = {
        ...
        u'services.servicegroup': {
            'Meta': {'ordering': "['order']", 'object_name': 'ServiceGroup'},
            'active': ('django.db.models.fields.CharField', [], {'default': "u'1'", 'max_length': '1'}),
        ...
        u'services.servicegroupdetail': {
            'Meta': {'ordering': "['order']", 'object_name': 'ServiceGroupDetail'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['services.Service']"}),
