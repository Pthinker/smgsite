...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageSlide'
        db.create_table(u'site_imageslide', (
            ...
            ('display_time', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('target', self.gf('django.db.models.fields.CharField')(default='_self', max_length=10)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'site', ['ImageSlide'])


    def backwards(self, orm):
        # Deleting model 'ImageSlide'
        db.delete_table(u'site_imageslide')
    ...
    models = {
        ...
        u'site.imageslide': {
            'Meta': {'object_name': 'ImageSlide'},
            'active': ('django.db.models.fields.CharField', [], {'default': "u'1'", 'max_length': '1'}),
            'display_time': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'for_update': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
