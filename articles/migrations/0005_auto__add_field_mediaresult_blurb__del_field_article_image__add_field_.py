...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaResult.blurb'
        db.add_column(u'articles_mediaresult', 'blurb',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Article.image'
        db.delete_column(u'articles_article', 'image')

        # Adding field 'Article.blurb'
        db.add_column(u'articles_article', 'blurb',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaResult.blurb'
        db.delete_column(u'articles_mediaresult', 'blurb')

        # Adding field 'Article.image'
        db.add_column(u'articles_article', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Article.blurb'
        db.delete_column(u'articles_article', 'blurb')
    ...
    models = {
        ...
        u'doctors.doctor': {
            ...
            'languages': ('django.db.models.fields.related.ManyToManyField', [], {'default': "'English'", 'to': u"orm['doctors.Language']", 'symmetrical': 'False'}),
