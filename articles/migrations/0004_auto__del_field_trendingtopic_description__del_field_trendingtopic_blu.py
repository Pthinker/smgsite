...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrendingTopic.description'
        db.delete_column(u'articles_trendingtopic', 'description')

        # Deleting field 'TrendingTopic.blurb'
        db.delete_column(u'articles_trendingtopic', 'blurb')

        # Adding field 'TrendingTopic.headline'
        db.add_column(u'articles_trendingtopic', 'headline',
                      self.gf('django.db.models.fields.CharField')(default='headline', max_length=200),
                      keep_default=False)

        # Adding field 'TrendingTopic.content'
        db.add_column(u'articles_trendingtopic', 'content',
                      self.gf('django.db.models.fields.TextField')(default='content'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TrendingTopic.description'
        db.add_column(u'articles_trendingtopic', 'description',
                      self.gf('django.db.models.fields.CharField')(default='description', max_length=200),
                      keep_default=False)

        # Adding field 'TrendingTopic.blurb'
        db.add_column(u'articles_trendingtopic', 'blurb',
                      self.gf('django.db.models.fields.CharField')(default='blurb', max_length=200),
                      keep_default=False)

        # Deleting field 'TrendingTopic.headline'
        db.delete_column(u'articles_trendingtopic', 'headline')

        # Deleting field 'TrendingTopic.content'
        db.delete_column(u'articles_trendingtopic', 'content')
