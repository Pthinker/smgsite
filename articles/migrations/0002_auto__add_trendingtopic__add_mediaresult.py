...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrendingTopic'
        db.create_table(u'articles_trendingtopic', (
            ...
            ('sort_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None, null=True)),
        ))
        db.send_create_signal(u'articles', ['TrendingTopic'])

        # Adding M2M table for field experts on 'TrendingTopic'
        m2m_table_name = db.shorten_name(u'articles_trendingtopic_experts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trendingtopic', models.ForeignKey(orm[u'articles.trendingtopic'], null=False)),
            ('doctor', models.ForeignKey(orm[u'doctors.doctor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['trendingtopic_id', 'doctor_id'])

        # Adding model 'MediaResult'
        db.create_table(u'articles_mediaresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('for_update', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2)),
            ('active', self.gf('django.db.models.fields.CharField')(default=u'1', max_length=1)),
            ...
            ('marketing_banner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mediaresult_marketing_banner', null=True, to=orm['marketing_banners.MarketingBanner'])),
            ('sort_order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None, null=True)),
        ))
        db.send_create_signal(u'articles', ['MediaResult'])

        # Adding M2M table for field aliases on 'MediaResult'
        m2m_table_name = db.shorten_name(u'articles_mediaresult_aliases')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mediaresult', models.ForeignKey(orm[u'articles.mediaresult'], null=False)),
            ('urlalias', models.ForeignKey(orm[u'articles.urlalias'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mediaresult_id', 'urlalias_id'])


    def backwards(self, orm):
        # Deleting model 'TrendingTopic'
        db.delete_table(u'articles_trendingtopic')

        # Removing M2M table for field experts on 'TrendingTopic'
        db.delete_table(db.shorten_name(u'articles_trendingtopic_experts'))

        # Deleting model 'MediaResult'
        db.delete_table(u'articles_mediaresult')

        # Removing M2M table for field aliases on 'MediaResult'
        db.delete_table(db.shorten_name(u'articles_mediaresult_aliases'))
