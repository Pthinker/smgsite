...
//	var ie5 = (document.namespaces==null);
	...
	function showMenu()
	{
		...
		mb.style.cssText ="border:solid 1px #ccc;margin:0;padding:0;overflow-y:auto;overflow-x:auto;background:white;text-aligbn:center;font-family:Arial;font-size:11px;";
		...
		{
			//alert( mb.options[i].getAttribute("value") );
			//mb.options[i].value = mb.options[i].getAttribute("value");
