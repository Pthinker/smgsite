...
var sections = {"doctor": 1, "service": 1, "specialty": 1};
...
function searchSite(name) {
    ...
    if (element.val().length >= 2) {
        ...
        $(prefix + '-more-results-href').attr('href', '/search/?q=' + encodeURIComponent(element.val()));
        $(prefix + '-more-results-href2').attr('href', '/search/?q=' + encodeURIComponent(element.val()));
